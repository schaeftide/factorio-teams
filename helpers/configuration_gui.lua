...
function ConfigurationGui:createNextAndPrev(gui)
    ...
    local s = ConfigurationGui.steps[ConfigurationGui.currentStep];
...
function ConfigurationGui:createConfigurationGui(player)
    -- init first step ;)
    local g = ConfigurationGui:try(ConfigurationGui.steps[ConfigurationGui.currentStep].createStep, player);
